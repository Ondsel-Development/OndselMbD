...
namespace MbD {
	...
	public:
		DispCompIeqcJecO() {}
		DispCompIeqcJecO(EndFrmsptr frmi, EndFrmsptr frmj, size_t axisO) : DispCompIecJecO(frmi, frmj, axisO) {}
		static std::shared_ptr<DispCompIeqcJecO> With(EndFrmsptr frmi, EndFrmsptr frmj, size_t axis);
