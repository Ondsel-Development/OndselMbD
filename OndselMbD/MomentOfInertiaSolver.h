...
namespace MbD {
	...
	public:
		static std::shared_ptr<MomentOfInertiaSolver> With();

		static void example1();
		void doFullPivoting(size_t p) const;
		...
		FMatDsptr getJoo() const;
		DiagMatDsptr getJpp() const;
		FMatDsptr getAPp() const;
		void calc();
		void calcJoo();
		void calcJpp();
		void calcAPp();
