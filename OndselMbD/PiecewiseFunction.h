...
namespace MbD {
	...
	public:
		...
		static std::shared_ptr<PiecewiseFunction> With();
		static std::shared_ptr<PiecewiseFunction> With(Symsptr var, std::shared_ptr<std::vector<Symsptr>> funcs, std::shared_ptr<std::vector<Symsptr>> trans);
