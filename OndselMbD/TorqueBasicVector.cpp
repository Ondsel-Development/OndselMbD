...
void MbD::TorqueBasicVector::fillpFpypFTOpXjpFTOpEjpartj(SpMatDsptr mat, FMatDsptr pFTOpXj, FMatDsptr pFTOpEj, PartFrame* partj)
{
	mat->atandplusFullMatrix(iqE, partj->iqX, twoBT->timesFullMatrix(pFTOpXj));
	mat->atandplusFullMatrix(iqE, partj->iqE, twoBT->timesFullMatrix(pFTOpEj));
}

void MbD::TorqueBasicVector::fillpFpydotpFTOpEdotjpartj(SpMatDsptr mat, FMatDsptr pFTOpEdotj, PartFrame* partj)
{
	assert(false);
}
...
void MbD::TorqueBasicVector::fillpFpydotpFTOpXdotjpartj(SpMatDsptr mat, FMatDsptr pFTOpXdotj, PartFrame* partj)
{
	assert(false);
}

void MbD::TorqueBasicVector::fillpFpydotpFTOpXdotjpFTOpEdotjpartj(SpMatDsptr mat, FMatDsptr pFTOpXdotj, FMatDsptr pFTOpEdotj, PartFrame* partj)
{
	assert(false);
}
